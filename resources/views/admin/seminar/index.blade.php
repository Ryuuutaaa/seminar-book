<x-app-layout>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-10">
        ...
        <div class="flex justify-between">
            ...
            <a href="{{ route('transaction.export-pdf') }}" target="_blank">
                <button type="button"
                    class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Export
                    PDF</button>
            </a>
        </div>
